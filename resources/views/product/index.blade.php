                ...
                <div class="p-6 text-gray-200">
                    ...
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <a href="{{ route('product.create') }}"
                           class="inline-flex items-center gap-2 px-4 py-2 bg-indigo-500 hover:bg-indigo-600 text-white text-sm font-medium rounded-lg transition duration-150 shadow-sm">
                            ...
                            <tbody class="bg-gray-800 divide-y divide-gray-700">
                                @forelse ($products as $product)
                                    <tr class="hover:bg-gray-700/50 transition duration-150">
                                        ...
                                        <td class="px-6 py-4 text-gray-400">
                                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $product->qty > 10 ? 'bg-green-900/50 text-green-400' : 'bg-red-900/50 text-red-400' }}">
                                                {{ $product->qty }}
                                            </span>
                                        </td>
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="flex items-center justify-center gap-2">
                                                <a href="{{ route('product.show', $product->id) }}"
                                                   class="p-1.5 rounded-md text-gray-500 hover:text-indigo-400 hover:bg-gray-700 transition"
                                                   title="View">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
